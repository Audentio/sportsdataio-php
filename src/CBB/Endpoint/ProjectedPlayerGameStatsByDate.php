...
class ProjectedPlayerGameStatsByDate extends \Sportsdata\API\CBB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CBB\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{date}', '{format}'), array($this->date, $this->format), '/stats/{format}/PlayerGameProjectionStatsByDate/{date}');
    }
