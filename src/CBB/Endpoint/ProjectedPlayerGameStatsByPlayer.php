...
class ProjectedPlayerGameStatsByPlayer extends \Sportsdata\API\CBB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CBB\Runtime\Client\Endpoint
{
    protected $playerid;
    protected $date;
    protected $format;
    ...
    */
    ...
    {
        return str_replace(array('{playerid}', '{date}', '{format}'), array($this->playerid, $this->date, $this->format), '/stats/{format}/PlayerGameProjectionStatsByPlayer/{date}/{playerid}');
    }
