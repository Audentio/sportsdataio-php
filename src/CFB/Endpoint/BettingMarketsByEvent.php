...
class BettingMarketsByEvent extends \Sportsdata\API\CFB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CFB\Runtime\Client\Endpoint
{
    protected $format;
    protected $eventId;
    /**
     ...
     */
    public function __construct(string $format, string $eventId)
    {
        $this->format = $format;
