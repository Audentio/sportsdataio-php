...
class BettingMarketsByMarketType extends \Sportsdata\API\CFB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CFB\Runtime\Client\Endpoint
{
    protected $format;
    protected $eventId;
     ...
     */
    public function __construct(string $format, string $eventId, string $marketTypeID)
    {
        $this->format = $format;
