...
class CurrentWeek extends \Sportsdata\API\CFB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CFB\Runtime\Client\Endpoint
{
    protected $format;
    /**
     * 
    ...
    {
        return str_replace(array('{format}'), array($this->format), '/scores/{format}/CurrentWeek');
    }
