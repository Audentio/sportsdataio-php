...
class TeamGameStatsByWeek extends \Sportsdata\API\CFB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CFB\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $format;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{format}'), array($this->week, $this->season, $this->format), '/scores/{format}/TeamGameStatsByWeek/{season}/{week}');
    }
