...
class ConferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\CFB\\Model\\Conference';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\CFB\\Model\\Conference';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\CFB\Model\Conference();
        ...
        if (\array_key_exists('Teams', $data)) {
            ...
            foreach ($data['Teams'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\CFB\\Model\\Team', 'json', $context);
            }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getConferenceName()) {
            $data['ConferenceName'] = $object->getConferenceName();
        }
        if (null !== $object->getDivisionName()) {
