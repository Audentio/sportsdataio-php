...
class MatchupTrendsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\CFB\\Model\\MatchupTrends';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\CFB\\Model\\MatchupTrends';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\CFB\Model\MatchupTrends();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('UpcomingGame', $data)) {
            $object->setUpcomingGame($this->denormalizer->denormalize($data['UpcomingGame'], 'Sportsdata\\API\\CFB\\Model\\Game', 'json', $context));
        }
        if (\array_key_exists('TeamTrends', $data)) {
            $values = array();
            foreach ($data['TeamTrends'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\CFB\\Model\\TeamTrends', 'json', $context);
            }
        ...
        if (\array_key_exists('TeamMatchupTrends', $data)) {
            ...
            foreach ($data['TeamMatchupTrends'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\CFB\\Model\\TeamGameTrends', 'json', $context);
            }
        ...
        if (\array_key_exists('OpponentMatchupTrends', $data)) {
            ...
            foreach ($data['OpponentMatchupTrends'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Sportsdata\\API\\CFB\\Model\\TeamGameTrends', 'json', $context);
            }
        ...
        if (\array_key_exists('PreviousGames', $data)) {
            ...
            foreach ($data['PreviousGames'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Sportsdata\\API\\CFB\\Model\\Game', 'json', $context);
            }
