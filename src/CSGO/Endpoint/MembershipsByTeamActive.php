...
class MembershipsByTeamActive extends \Sportsdata\API\CSGO\Runtime\Client\BaseEndpoint implements \Sportsdata\API\CSGO\Runtime\Client\Endpoint
{
    protected $teamid;
    protected $format;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{teamid}', '{format}'), array($this->teamid, $this->format), '/scores/{format}/MembershipsByTeam/{teamid}');
    }
     ...
     *
     *
     * @return null|\Sportsdata\API\CSGO\Model\Membership[]|\Sportsdata\API\CSGO\Model\Error
     */
