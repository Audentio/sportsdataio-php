...
class SeasonTeamNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\CSGO\\Model\\SeasonTeam';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\CSGO\\Model\\SeasonTeam';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\CSGO\Model\SeasonTeam();
        ...
        if (\array_key_exists('Team', $data)) {
            $object->setTeam($this->denormalizer->denormalize($data['Team'], 'Sportsdata\\API\\CSGO\\Model\\Team', 'json', $context));
        }
        return $object;
    }
