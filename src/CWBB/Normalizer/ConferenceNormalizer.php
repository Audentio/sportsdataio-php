...
class ConferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\CWBB\\Model\\Conference';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\CWBB\\Model\\Conference';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\CWBB\Model\Conference();
        ...
        if (\array_key_exists('Teams', $data)) {
            ...
            foreach ($data['Teams'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\CWBB\\Model\\Team', 'json', $context);
            }
