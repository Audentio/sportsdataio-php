...
class NewsByDate extends \Sportsdata\API\Golf\Runtime\Client\BaseEndpoint implements \Sportsdata\API\Golf\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{date}', '{format}'), array($this->date, $this->format), '/{format}/NewsByDate/{date}');
    }
     ...
     *
     *
     * @return null|\Sportsdata\API\Golf\Model\News[]|\Sportsdata\API\Golf\Model\Error
     */
