...
class PlayerMatchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\LOL\\Model\\PlayerMatch';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\LOL\\Model\\PlayerMatch';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\LOL\Model\PlayerMatch();
        ...
        if (\array_key_exists('Lane', $data) && $data['Lane'] !== null) {
            $object->setLane($data['Lane']);
        }
        elseif (\array_key_exists('Lane', $data) && $data['Lane'] === null) {
            $object->setLane(null);
        }
        ...
        if (\array_key_exists('ChampionLevel', $data) && $data['ChampionLevel'] !== null) {
            $object->setChampionLevel($data['ChampionLevel']);
        }
        elseif (\array_key_exists('ChampionLevel', $data) && $data['ChampionLevel'] === null) {
            $object->setChampionLevel(null);
        }
        ...
        if (\array_key_exists('Items', $data)) {
            ...
            foreach ($data['Items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\LOL\\Model\\Item', 'json', $context);
            }
            $object->setItems($values);
        }
        if (\array_key_exists('Spells', $data)) {
            $values_1 = array();
            foreach ($data['Spells'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\LOL\\Model\\Spell', 'json', $context);
            }
            $object->setSpells($values_1);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getLane()) {
            $data['Lane'] = $object->getLane();
        }
        ...
        if (null !== $object->getChampionLevel()) {
            $data['ChampionLevel'] = $object->getChampionLevel();
        }
        ...
        if (null !== $object->getSpells()) {
            $values_1 = array();
            foreach ($object->getSpells() as $value_1) {
                $values_1[] = $this->normalizer->normalize($value_1, 'json', $context);
            }
            $data['Spells'] = $values_1;
        }
