...
class PlayerPropsByDate extends \Sportsdata\API\MLB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\MLB\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
     ...
     *
     *
     * @return null|\Sportsdata\API\MLB\Model\PlayerProp[]
     */
