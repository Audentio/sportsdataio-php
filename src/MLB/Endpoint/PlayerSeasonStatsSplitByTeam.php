...
class PlayerSeasonStatsSplitByTeam extends \Sportsdata\API\MLB\Runtime\Client\BaseEndpoint implements \Sportsdata\API\MLB\Runtime\Client\Endpoint
{
    protected $season;
    protected $format;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{season}', '{format}'), array($this->season, $this->format), '/stats/{format}/PlayerSeasonStatsSplitByTeam/{season}');
    }
