...
class ConsensusOutcome
{
     ...
     * @return int
     */
    public function getNumberOfSportsbooks() : int
    {
        return $this->numberOfSportsbooks;
    }
    /**
     * 
     *
     * @param int $numberOfSportsbooks
     *
     * @return self
     */
    public function setNumberOfSportsbooks(int $numberOfSportsbooks) : self
    {
        $this->numberOfSportsbooks = $numberOfSportsbooks;
        return $this;
    }
    /**
     * 
