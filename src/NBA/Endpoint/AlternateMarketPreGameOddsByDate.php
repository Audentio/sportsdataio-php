...
class AlternateMarketPreGameOddsByDate extends \Sportsdata\API\NBA\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NBA\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
    ...
    {
        return str_replace(array('{date}', '{format}'), array($this->date, $this->format), '/odds/{format}/AlternateMarketGameOddsByDate/{date}');
    }
