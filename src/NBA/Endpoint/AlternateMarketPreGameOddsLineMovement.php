...
class AlternateMarketPreGameOddsLineMovement extends \Sportsdata\API\NBA\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NBA\Runtime\Client\Endpoint
{
    protected $format;
    protected $gameid;
    /**
    ...
    {
        return str_replace(array('{format}', '{gameid}'), array($this->format, $this->gameid), '/odds/{format}/AlternateMarketGameOddsLineMovement/{gameid}');
    }
     ...
     *
     *
     * @return null|\Sportsdata\API\NBA\Model\GameInfo[]
     */
