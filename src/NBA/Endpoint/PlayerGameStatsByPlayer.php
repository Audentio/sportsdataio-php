...
class PlayerGameStatsByPlayer extends \Sportsdata\API\NBA\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NBA\Runtime\Client\Endpoint
{
    protected $playerid;
    protected $date;
    protected $format;
    ...
    */
     ...
     *
     *
     * @return null|\Sportsdata\API\NBA\Model\PlayerGame|\Sportsdata\API\NBA\Model\Error
     */
