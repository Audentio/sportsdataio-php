...
class ProjectedPlayerGameStatsByDateWInjuriesDfsSalaries extends \Sportsdata\API\NBA\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NBA\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
