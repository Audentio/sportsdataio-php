...
class Player
{
     ...
     * @return int|null
     */
    public function getNbaDotComPlayerID() : ?int
    {
        return $this->nbaDotComPlayerID;
    }
    /**
     * 
     *
     * @param int|null $nbaDotComPlayerID
     *
     * @return self
     */
    public function setNbaDotComPlayerID(?int $nbaDotComPlayerID) : self
    {
