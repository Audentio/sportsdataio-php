...
class PlayerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NBA\\Model\\Player';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NBA\\Model\\Player';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NBA\Model\Player();
        ...
        if (\array_key_exists('DepthChartPosition', $data) && $data['DepthChartPosition'] !== null) {
            $object->setDepthChartPosition($data['DepthChartPosition']);
        }
        elseif (\array_key_exists('DepthChartPosition', $data) && $data['DepthChartPosition'] === null) {
            $object->setDepthChartPosition(null);
        }
        if (\array_key_exists('DepthChartOrder', $data) && $data['DepthChartOrder'] !== null) {
            $object->setDepthChartOrder($data['DepthChartOrder']);
        }
        elseif (\array_key_exists('DepthChartOrder', $data) && $data['DepthChartOrder'] === null) {
            $object->setDepthChartOrder(null);
        }
        ...
        if (\array_key_exists('NbaDotComPlayerID', $data) && $data['NbaDotComPlayerID'] !== null) {
            $object->setNbaDotComPlayerID($data['NbaDotComPlayerID']);
        }
        elseif (\array_key_exists('NbaDotComPlayerID', $data) && $data['NbaDotComPlayerID'] === null) {
            $object->setNbaDotComPlayerID(null);
        }
        return $object;
    }
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getDepthChartPosition()) {
            $data['DepthChartPosition'] = $object->getDepthChartPosition();
        }
        if (null !== $object->getDepthChartOrder()) {
            $data['DepthChartOrder'] = $object->getDepthChartOrder();
        }
        ...
        if (null !== $object->getNbaDotComPlayerID()) {
            $data['NbaDotComPlayerID'] = $object->getNbaDotComPlayerID();
        }
        return $data;
    }
}