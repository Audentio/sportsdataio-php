...
class TeamTrendsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NBA\\Model\\TeamTrends';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NBA\\Model\\TeamTrends';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NBA\Model\TeamTrends();
        ...
        if (\array_key_exists('TeamGameTrends', $data)) {
            ...
            foreach ($data['TeamGameTrends'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\NBA\\Model\\TeamGameTrends', 'json', $context);
            }
