...
class AdvancedPlayerGameStatsByPlayer extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(array('{format}', '{season}', '{playerid}'), array($this->format, $this->season, $this->playerid), '/advanced-metrics/{format}/AdvancedPlayerGameStatsByPlayerID/{season}/{playerid}');
    }
