...
class AdvancedPlayerSeasonStatsByPlayer extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(array('{playerid}', '{season}', '{format}'), array($this->playerid, $this->season, $this->format), '/advanced-metrics/{format}/AdvancedPlayerSeasonStatsByPlayerID/{season}/{playerid}');
    }
     ...
     *
     *
     * @return null|\Sportsdata\API\NFL\Model\AdvancedPlayerSeason[]|\Sportsdata\API\NFL\Model\Error
     */
