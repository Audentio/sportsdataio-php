...
class BettingFuturesBySeason extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $season;
    protected $format;
    /**
     ...
     *
     *
     * @return null|\Sportsdata\API\NFL\Model\BettingEvent[]
     */
