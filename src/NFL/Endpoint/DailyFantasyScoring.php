...
class DailyFantasyScoring extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $date;
    protected $format;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{date}', '{format}'), array($this->date, $this->format), '/stats/{format}/DailyFantasyPoints/{date}');
    }
