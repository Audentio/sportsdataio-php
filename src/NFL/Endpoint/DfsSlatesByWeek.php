...
class DfsSlatesByWeek extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $format;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{format}'), array($this->week, $this->season, $this->format), '/projections/{format}/DfsSlatesByWeek/{season}/{week}');
    }
     ...
     *
     *
     * @return null|\Sportsdata\API\NFL\Model\DfsSlate[]|\Sportsdata\API\NFL\Model\Error
     */
