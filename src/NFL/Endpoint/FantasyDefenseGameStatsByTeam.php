...
class FantasyDefenseGameStatsByTeam extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{team}', '{format}'), array($this->week, $this->season, $this->team, $this->format), '/stats/{format}/FantasyDefenseByGameByTeam/{season}/{week}/{team}');
    }
