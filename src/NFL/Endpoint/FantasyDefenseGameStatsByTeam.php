...
class FantasyDefenseGameStatsByTeam extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $format;
    protected $season;
    protected $week;
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}', '{team}'), array($this->format, $this->season, $this->week, $this->team), '/stats/{format}/FantasyDefenseByGameByTeam/{season}/{week}/{team}');
    }
