...
class FantasyDefenseSeasonStatsByTeam extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $team;
    protected $season;
    protected $format;
    ...
    */
    ...
    {
        return str_replace(array('{team}', '{season}', '{format}'), array($this->team, $this->season, $this->format), '/stats/{format}/FantasyDefenseBySeasonByTeam/{season}/{team}');
    }
