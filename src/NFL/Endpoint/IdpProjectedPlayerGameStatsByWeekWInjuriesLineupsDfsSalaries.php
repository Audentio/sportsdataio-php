...
class IdpProjectedPlayerGameStatsByWeekWInjuriesLineupsDfsSalaries extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $format;
    protected $season;
    protected $week;
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}'), array($this->format, $this->season, $this->week), '/projections/{format}/IdpPlayerGameProjectionStatsByWeek/{season}/{week}');
    }
