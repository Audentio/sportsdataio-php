...
class InGameOddsLineMovement extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $scoreid;
    protected $format;
    /**
    ...
    {
        return str_replace(array('{scoreid}', '{format}'), array($this->scoreid, $this->format), '/odds/{format}/LiveGameOddsLineMovement/{scoreid}');
    }
