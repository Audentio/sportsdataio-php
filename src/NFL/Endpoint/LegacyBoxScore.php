...
class LegacyBoxScore extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $hometeam;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{hometeam}', '{format}'), array($this->week, $this->season, $this->hometeam, $this->format), '/stats/{format}/BoxScore/{season}/{week}/{hometeam}');
    }
