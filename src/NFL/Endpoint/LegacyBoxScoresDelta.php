...
class LegacyBoxScoresDelta extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $minutes;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{minutes}', '{format}'), array($this->week, $this->season, $this->minutes, $this->format), '/stats/{format}/BoxScoresDelta/{season}/{week}/{minutes}');
    }
