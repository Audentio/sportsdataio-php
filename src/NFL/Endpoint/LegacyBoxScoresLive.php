...
class LegacyBoxScoresLive extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $format;
    /**
     * 
    ...
    {
        return str_replace(array('{format}'), array($this->format), '/stats/{format}/LiveBoxScores');
    }
