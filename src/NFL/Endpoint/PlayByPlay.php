...
class PlayByPlay extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $hometeam;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{hometeam}', '{format}'), array($this->week, $this->season, $this->hometeam, $this->format), '/pbp/{format}/PlayByPlay/{season}/{week}/{hometeam}');
    }
