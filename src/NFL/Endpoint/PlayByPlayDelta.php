...
class PlayByPlayDelta extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}', '{minutes}'), array($this->format, $this->season, $this->week, $this->minutes), '/pbp/{format}/PlayByPlayDelta/{season}/{week}/{minutes}');
    }
