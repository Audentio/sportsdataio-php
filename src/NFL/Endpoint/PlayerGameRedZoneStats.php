...
class PlayerGameRedZoneStats extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $week;
    protected $season;
    protected $format;
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{format}'), array($this->week, $this->season, $this->format), '/stats/{format}/PlayerGameRedZoneStats/{season}/{week}');
    }
