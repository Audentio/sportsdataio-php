...
class PlayerGameStatsByTeam extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}', '{team}'), array($this->format, $this->season, $this->week, $this->team), '/stats/{format}/PlayerGameStatsByTeam/{season}/{week}/{team}');
    }
