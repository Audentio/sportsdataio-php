...
class PlayerGameStatsByWeekDelta extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $format;
    protected $season;
    protected $week;
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}', '{minutes}'), array($this->format, $this->season, $this->week, $this->minutes), '/stats/{format}/PlayerGameStatsByWeekDelta/{season}/{week}/{minutes}');
    }
