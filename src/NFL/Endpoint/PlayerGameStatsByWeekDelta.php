...
class PlayerGameStatsByWeekDelta extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{week}', '{season}', '{minutes}', '{format}'), array($this->week, $this->season, $this->minutes, $this->format), '/stats/{format}/PlayerGameStatsByWeekDelta/{season}/{week}/{minutes}');
    }
