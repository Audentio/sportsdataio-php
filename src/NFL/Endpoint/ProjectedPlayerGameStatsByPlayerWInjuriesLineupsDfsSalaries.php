...
class ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalaries extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{format}', '{season}', '{week}', '{playerid}'), array($this->format, $this->season, $this->week, $this->playerid), '/projections/{format}/PlayerGameProjectionStatsByPlayerID/{season}/{week}/{playerid}');
    }
