...
class ScoresBySeason extends \Sportsdata\API\NFL\Runtime\Client\BaseEndpoint implements \Sportsdata\API\NFL\Runtime\Client\Endpoint
{
    protected $season;
    protected $format;
    /**
    ...
    {
        return str_replace(array('{season}', '{format}'), array($this->season, $this->format), '/scores/{format}/Scores/{season}');
    }
