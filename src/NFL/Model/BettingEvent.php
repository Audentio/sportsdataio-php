...
class BettingEvent
{
     ...
     * @return int|null
     */
    public function getGlobalScoreID() : ?int
    {
        return $this->globalScoreID;
    }
    /**
     * 
     *
     * @param int|null $globalScoreID
     *
     * @return self
     */
    public function setGlobalScoreID(?int $globalScoreID) : self
    {
