...
class DfsSlatePlayer
{
     ...
     * @var int|null
     */
    protected $fantasyDefenseProjectionStatID;
    /**
     * 
     *
     * @var string|null
     ...
     * @return int|null
     */
    public function getFantasyDefenseProjectionStatID() : ?int
    {
        return $this->fantasyDefenseProjectionStatID;
    }
    /**
     * 
     *
     * @param int|null $fantasyDefenseProjectionStatID
     *
     * @return self
     */
    public function setFantasyDefenseProjectionStatID(?int $fantasyDefenseProjectionStatID) : self
    {
