...
class ConsensusOutcomeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NFL\\Model\\ConsensusOutcome';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NFL\\Model\\ConsensusOutcome';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NFL\Model\ConsensusOutcome();
        ...
        if (\array_key_exists('SportsBook', $data)) {
            $object->setSportsBook($this->denormalizer->denormalize($data['SportsBook'], 'Sportsdata\\API\\NFL\\Model\\Sportsbook', 'json', $context));
        }
