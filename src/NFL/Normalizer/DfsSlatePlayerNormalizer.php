...
class DfsSlatePlayerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NFL\\Model\\DfsSlatePlayer';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NFL\\Model\\DfsSlatePlayer';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NFL\Model\DfsSlatePlayer();
        ...
        if (\array_key_exists('FantasyDefenseProjectionStatID', $data) && $data['FantasyDefenseProjectionStatID'] !== null) {
            $object->setFantasyDefenseProjectionStatID($data['FantasyDefenseProjectionStatID']);
        }
        elseif (\array_key_exists('FantasyDefenseProjectionStatID', $data) && $data['FantasyDefenseProjectionStatID'] === null) {
            $object->setFantasyDefenseProjectionStatID(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getFantasyDefenseProjectionStatID()) {
            $data['FantasyDefenseProjectionStatID'] = $object->getFantasyDefenseProjectionStatID();
        }
