...
class FantasyDefenseGameNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NFL\\Model\\FantasyDefenseGame';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NFL\\Model\\FantasyDefenseGame';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NFL\Model\FantasyDefenseGame();
        ...
        if (\array_key_exists('FantasyDefenseID', $data) && $data['FantasyDefenseID'] !== null) {
            $object->setFantasyDefenseID($data['FantasyDefenseID']);
        }
        elseif (\array_key_exists('FantasyDefenseID', $data) && $data['FantasyDefenseID'] === null) {
            $object->setFantasyDefenseID(null);
        }
