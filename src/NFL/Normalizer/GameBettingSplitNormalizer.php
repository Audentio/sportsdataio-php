...
class GameBettingSplitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NFL\\Model\\GameBettingSplit';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NFL\\Model\\GameBettingSplit';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NFL\Model\GameBettingSplit();
        ...
        if (\array_key_exists('BettingMarketSplits', $data)) {
            $values = array();
            foreach ($data['BettingMarketSplits'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\NFL\\Model\\BettingMarketSplit', 'json', $context);
            }
            $object->setBettingMarketSplits($values);
        }
        return $object;
    }
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getBettingMarketSplits()) {
            $values = array();
            foreach ($object->getBettingMarketSplits() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $data['BettingMarketSplits'] = $values;
        }
        return $data;
    }
}