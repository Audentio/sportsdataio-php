...
class GameInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NFL\\Model\\GameInfo';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NFL\\Model\\GameInfo';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NFL\Model\GameInfo();
        ...
        if (\array_key_exists('PregameOdds', $data)) {
            ...
            foreach ($data['PregameOdds'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\NFL\\Model\\GameOdd', 'json', $context);
            }
        ...
        if (\array_key_exists('LiveOdds', $data)) {
            ...
            foreach ($data['LiveOdds'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\NFL\\Model\\GameOdd', 'json', $context);
            }
        ...
        if (\array_key_exists('AlternateMarketPregameOdds', $data)) {
            ...
            foreach ($data['AlternateMarketPregameOdds'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Sportsdata\\API\\NFL\\Model\\GameOdd', 'json', $context);
            }
