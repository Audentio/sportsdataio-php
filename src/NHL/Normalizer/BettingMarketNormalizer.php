...
class BettingMarketNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NHL\\Model\\BettingMarket';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NHL\\Model\\BettingMarket';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NHL\Model\BettingMarket();
        ...
        if (\array_key_exists('AvailableSportsbooks', $data)) {
            ...
            foreach ($data['AvailableSportsbooks'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\NHL\\Model\\Sportsbook', 'json', $context);
            }
        ...
        if (\array_key_exists('BettingOutcomes', $data)) {
            ...
            foreach ($data['BettingOutcomes'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\NHL\\Model\\BettingOutcome', 'json', $context);
            }
        ...
        if (\array_key_exists('ConsensusOutcomes', $data)) {
            ...
            foreach ($data['ConsensusOutcomes'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Sportsdata\\API\\NHL\\Model\\ConsensusOutcome', 'json', $context);
            }
