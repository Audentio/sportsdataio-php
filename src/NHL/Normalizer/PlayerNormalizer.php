...
class PlayerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\NHL\\Model\\Player';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\NHL\\Model\\Player';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\NHL\Model\Player();
        ...
        if (\array_key_exists('Catches', $data) && $data['Catches'] !== null) {
            $object->setCatches($data['Catches']);
        }
        elseif (\array_key_exists('Catches', $data) && $data['Catches'] === null) {
            $object->setCatches(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getCatches()) {
            $data['Catches'] = $object->getCatches();
        }
