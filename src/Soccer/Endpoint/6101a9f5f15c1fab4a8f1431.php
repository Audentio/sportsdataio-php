...
class 6101a9f5f15c1fab4a8f1431 extends \Sportsdata\API\Soccer\Runtime\Client\BaseEndpoint implements \Sportsdata\API\Soccer\Runtime\Client\Endpoint
{
    protected $season;
    ...
    {
        return str_replace(array('{season}', '{competition}', '{format}'), array($this->season, $this->competition, $this->format), '/odds/{format}/BettingEvents/{competition}/{season}');
    }
