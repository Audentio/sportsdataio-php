...
class MembershipsActive extends \Sportsdata\API\Soccer\Runtime\Client\BaseEndpoint implements \Sportsdata\API\Soccer\Runtime\Client\Endpoint
{
    protected $format;
    /**
     * 
    ...
    {
        return str_replace(array('{format}'), array($this->format), '/scores/{format}/ActiveMemberships');
    }
