...
class MembershipsByCompetitionActive extends \Sportsdata\API\Soccer\Runtime\Client\BaseEndpoint implements \Sportsdata\API\Soccer\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(array('{competition}', '{format}'), array($this->competition, $this->format), '/scores/{format}/MembershipsByCompetition/{competition}');
    }
