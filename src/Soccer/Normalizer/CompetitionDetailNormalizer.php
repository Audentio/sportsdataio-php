...
class CompetitionDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\Soccer\\Model\\CompetitionDetail';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\Soccer\\Model\\CompetitionDetail';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\Soccer\Model\CompetitionDetail();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('CurrentSeason', $data)) {
            $object->setCurrentSeason($this->denormalizer->denormalize($data['CurrentSeason'], 'Sportsdata\\API\\Soccer\\Model\\Season', 'json', $context));
        }
        if (\array_key_exists('Teams', $data)) {
            $values = array();
            foreach ($data['Teams'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\Soccer\\Model\\TeamDetail', 'json', $context);
            }
        ...
        if (\array_key_exists('Games', $data)) {
            ...
            foreach ($data['Games'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\Soccer\\Model\\Game', 'json', $context);
            }
        ...
        if (\array_key_exists('Seasons', $data)) {
            ...
            foreach ($data['Seasons'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Sportsdata\\API\\Soccer\\Model\\Season', 'json', $context);
            }
