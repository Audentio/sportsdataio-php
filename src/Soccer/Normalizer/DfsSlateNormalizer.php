...
class DfsSlateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sportsdata\\API\\Soccer\\Model\\DfsSlate';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Sportsdata\\API\\Soccer\\Model\\DfsSlate';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sportsdata\API\Soccer\Model\DfsSlate();
        ...
        if (\array_key_exists('DfsSlateGames', $data)) {
            ...
            foreach ($data['DfsSlateGames'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Sportsdata\\API\\Soccer\\Model\\DfsSlateGame', 'json', $context);
            }
        ...
        if (\array_key_exists('DfsSlatePlayers', $data)) {
            ...
            foreach ($data['DfsSlatePlayers'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Sportsdata\\API\\Soccer\\Model\\DfsSlatePlayer', 'json', $context);
            }
        ...
        if (\array_key_exists('CompetitionId', $data) && $data['CompetitionId'] !== null) {
            $object->setCompetitionId($data['CompetitionId']);
        }
        elseif (\array_key_exists('CompetitionId', $data) && $data['CompetitionId'] === null) {
            $object->setCompetitionId(null);
        }
        return $object;
    }
