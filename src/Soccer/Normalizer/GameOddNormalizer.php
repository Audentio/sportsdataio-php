...
class GameOddNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('HomeTeamAsianHandicap', $data) && $data['HomeTeamAsianHandicap'] !== null) {
            $object->setHomeTeamAsianHandicap($data['HomeTeamAsianHandicap']);
        }
        elseif (\array_key_exists('HomeTeamAsianHandicap', $data) && $data['HomeTeamAsianHandicap'] === null) {
            $object->setHomeTeamAsianHandicap(null);
        }
        if (\array_key_exists('AwayTeamAsianHandicap', $data) && $data['AwayTeamAsianHandicap'] !== null) {
            $object->setAwayTeamAsianHandicap($data['AwayTeamAsianHandicap']);
        }
        elseif (\array_key_exists('AwayTeamAsianHandicap', $data) && $data['AwayTeamAsianHandicap'] === null) {
            $object->setAwayTeamAsianHandicap(null);
        }
        if (\array_key_exists('HomeTeamAsianHandicapPayout', $data) && $data['HomeTeamAsianHandicapPayout'] !== null) {
            $object->setHomeTeamAsianHandicapPayout($data['HomeTeamAsianHandicapPayout']);
        }
        elseif (\array_key_exists('HomeTeamAsianHandicapPayout', $data) && $data['HomeTeamAsianHandicapPayout'] === null) {
            $object->setHomeTeamAsianHandicapPayout(null);
        }
        if (\array_key_exists('AwayTeamAsianHandicapPayout', $data) && $data['AwayTeamAsianHandicapPayout'] !== null) {
            $object->setAwayTeamAsianHandicapPayout($data['AwayTeamAsianHandicapPayout']);
        }
        elseif (\array_key_exists('AwayTeamAsianHandicapPayout', $data) && $data['AwayTeamAsianHandicapPayout'] === null) {
            $object->setAwayTeamAsianHandicapPayout(null);
        }
        if (\array_key_exists('AsianTotal', $data) && $data['AsianTotal'] !== null) {
            $object->setAsianTotal($data['AsianTotal']);
        }
        elseif (\array_key_exists('AsianTotal', $data) && $data['AsianTotal'] === null) {
            $object->setAsianTotal(null);
        }
        if (\array_key_exists('AsianTotalOverPayout', $data) && $data['AsianTotalOverPayout'] !== null) {
            $object->setAsianTotalOverPayout($data['AsianTotalOverPayout']);
        }
        elseif (\array_key_exists('AsianTotalOverPayout', $data) && $data['AsianTotalOverPayout'] === null) {
            $object->setAsianTotalOverPayout(null);
        }
        if (\array_key_exists('AsianTotalUnderPayout', $data) && $data['AsianTotalUnderPayout'] !== null) {
            $object->setAsianTotalUnderPayout($data['AsianTotalUnderPayout']);
        }
        elseif (\array_key_exists('AsianTotalUnderPayout', $data) && $data['AsianTotalUnderPayout'] === null) {
            $object->setAsianTotalUnderPayout(null);
        }
        return $object;
    }
